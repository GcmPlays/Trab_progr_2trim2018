...
int main()
{
    system("color 1E");//Configura as cores padrões de primeiro plano e plano de fundo do console
    ...
    FILE *filePtr;
    filePtr = fopen("C:\\Users\\GABRIEL\\Downloads\\strola.bmp","r+b");
...
int headerreader(FILE *adr, struct bmpheader *ptrheader,struct bmpinfoheader *ptrinfo)
{
    ...
    printf("\nO tamanho do arquivo é %d Bytes",cabecalho_bmp.bfSize);
...
{
	//Pula cabeçalho a partir do valor bfOffBits
